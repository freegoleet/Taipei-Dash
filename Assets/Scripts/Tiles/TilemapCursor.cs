...
namespace Traffic
{
    public class TilemapCursor : MonoBehaviour
    {
        ...
        [SerializeField]
        private SpriteRenderer m_HoverOverlay = null;
        ...
        public SpriteRenderer HoverOverlay { get => m_HoverOverlay; }
        ...
        public void SelectNewTileType(SO_Tile data) {
            ...
            switch (type) {
                case TileType.Road:
                    ...
                    RoadTile.Pointer.ToggleShow(Direction.Up, true);  
        ...
        public void SetHoverOverlayColor(Color color) {
            m_HoverOverlay.color = color;
        }
    }
}